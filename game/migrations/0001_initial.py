# Generated by Django 2.2.8 on 2020-05-09 17:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('active', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='active', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('Free', 'Free'), ('Claimed', 'Claimed'), ('Active', 'Active'), ('Invalid', 'Invalid')], default='Free', max_length=25)),
